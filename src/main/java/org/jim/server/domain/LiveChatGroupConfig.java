 ...
 */
@Entity
@Table(name="livechat_group_config")
@Data
public class LiveChatGroupConfig implements Serializable{
	...
	public static LiveChatGroupConfig getInitLiveChatGroupConfig(LiveChatGroup group) {
		LiveChatGroupConfig result = new LiveChatGroupConfig();
